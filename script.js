...
function updateAllCalculationsAndViews() {
    ...
    } else if (activeTab === 'data-analysis') {
...
// =================================================================
// == BUG FIX: Added missing updateHeadToHeadDropdowns function  ==
// =================================================================
function updateHeadToHeadDropdowns() {
    ...
    if (users.some(u => u.id === currentP1)) {
        p1Select.value = currentP1;
    } else if (users.length > 0) {
        p1Select.value = users[0].id;
    }

    if (users.some(u => u.id === currentP2) && currentP2 !== p1Select.value) {
        p2Select.value = currentP2;
    } else if (users.length > 1) {
        // Find a different player for the second dropdown
        const p1Value = p1Select.value;
        const defaultP2 = users.find(u => u.id !== p1Value);
        if (defaultP2) {
            p2Select.value = defaultP2.id;
        }
    }
}
